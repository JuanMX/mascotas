...
@section('title', 'Mark pets returning to the shelter')

@section('content_header')
    <h2><i class="{{Helper::getIconArrivalShelter()}}" aria-hidden="true"></i> &nbsp; Mark pets returning to the shelter</h2> 
@stop

@section('content')
    <x-adminlte-alert theme="warning" title="Use the 'Actions' column ONLY if the pet arrived at the shelter" dismissable></x-adminlte-alert>
    <div class="pt-3 pb-3">
